module PATH2
    ...
    if isfile(joinpath(dirname(dirname(@__FILE__)), "deps", "deps.jl"))
      ...
      error("PATH2 not properly installed. Please run Pkg.build(\"PATH2\")")
    end
    ...
    function solveMCP(f_eval::Function, lb::Vector, ub::Vector, guess::Vector, var_name=C_NULL, con_name=C_NULL; nnz = length(lb)^2)
      j_eval = x -> ForwardDiff.jacobian(f_eval, x)
      return solveMCP(f_eval, j_eval, lb, ub, guess, var_name, con_name, nnz = nnz)
    end

    function solveMCP(f_eval::Function, j_eval::Function, lb::Vector, ub::Vector,guess::Vector, var_name=C_NULL, con_name=C_NULL; nnz = length(lb)^2)
      user_f[] = f_eval
      user_j[] = j_eval
    ...
    function options(;kwargs...)
      ...
      println(opt_file, "* Generated by PATHS2.jl. Do not edit.")
